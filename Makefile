...
time-messure-quick: all
	node parallel-runner.js -i ./zadani -s priceweight -d $(QUICK_ITEMS_COUNT) -m

time-messure: all
	node parallel-runner.js -i ./zadani -s priceweight -d $(ITEMS_COUNT) -m
...
error-messure: all
	node parallel-runner.js -i ./zadani -s priceweight -d $(ITEMS_COUNT) -e ./reseni
